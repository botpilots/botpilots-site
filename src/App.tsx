...

				{
					...
					<div ref={scrollContainerRef} className="flex h-full w-screen overflow-x-auto snap-x snap-mandatory hide-scrollbar scroll-smooth">
						<section id="services" className="snap-center flex-shrink-0 w-screen flex flex-col sm:items-center items-start justify-start overflow-y-scroll snap-y snap-mandatory hide-scrollbar p-6">
							<div className="sm:snap-center snap-start flex-shrink-0 sm:min-h-full min-h-fit w-full flex sm:items-center items-start justify-center mb-6 [&>*]:max-w-[800px]">
								<Services />
							</div>
							<div className="sm:snap-center snap-start flex-shrink-0 sm:min-h-full min-h-fit w-full flex sm:items-center items-start justify-center [&>*]:max-w-[800px]">
								<Services2 />
							</div>
						</section>
